package eglabs.com.crushify.Fragments;
...
public class Newuser extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.activity_newuser, container, false);
        emailNewET=view.findViewById(R.id.email);
        passwordNewET=view.findViewById(R.id.password);
        return view;
    }
